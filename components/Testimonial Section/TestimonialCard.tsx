...
function TestimonialCard({ number }: Props) {
  return (
    <div
      className={`testimonial__card mt-20 shadow-xl h-[23rem] w-[13rem] md:min-h-[28rem] md:w-[28rem]  lg:w-[20rem]   rounded-3xl px-3 py-3 md:px-6 md:py-14 border-4 flex flex-col items-center justify-around
    ${
      number === 1
